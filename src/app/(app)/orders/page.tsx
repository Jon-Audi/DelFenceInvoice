...
export default function OrdersPage() {
    ...
    if (pendingOrderRaw) {
      ...
      try {
        ...
        const newOrderData: OrderFormData = {
          // id will be generated by form/dialog logic if it's a new entity
          ...
          date: new Date(), // Default to today for new order
          status: 'Ordered', // Default status
          orderState: 'Open', // Default state
          poNumber: estimateToConvert.poNumber || '',
          lineItems: estimateToConvert.lineItems.map(li => ({
            id: crypto.randomUUID(), // New ID for the order line item
            productId: li.productId,
            productName: li.productName, // This must be present from estimate
            quantity: li.quantity,
            unitPrice: li.unitPrice,     // This must be present from estimate
  ...
  }, [toast]); // Removed products from here as it's not needed for initial raw data transformation

  useEffect(() => {
    // This effect triggers the dialog once conversionOrderData is set and other data is loaded
