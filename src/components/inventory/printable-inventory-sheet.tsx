      ...
      <div ref={ref}>
        {Object.entries(groupedProducts).map(([category, productsInCategory]) => (
            <section key={category}>
                ...
                <thead>
                    <tr>
                    <th style={{ border: '1px solid #ddd', padding: '8px', textAlign: 'left', width: '60%' }}>Product Name</th>
                    <th style={{ border: '1px solid #ddd', padding: '8px', textAlign: 'right', width: '20%' }}>Current Stock</th>
                    <th style={{ border: '1px solid #ddd', padding: '8px', textAlign: 'left', width: '20%' }}>Manual Count</th>
                    </tr>
                </thead>
                <tbody>
